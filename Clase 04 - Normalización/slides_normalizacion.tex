...
\begin{frame}{Ejercicio práctico - Ventas de productos}
    Una empresa de ventas registra los pedidos de sus clientes. Se sabe que:
    \begin{itemize}
    ...
    \resizebox{\textwidth}{!}{
     \begin{tabular}{ccccccc}
        ...
        2 & Maria & 1000 & CABA & Mouse & Electrónica & 20 \\
...
\begin{frame}{Ejercicio práctico - Paso 3: 3FN (1)}
    \begin{center}
    \textbf{Productos (igual que en 2FN)}\\[0.1cm]
    \begin{tabular}{cccc}
        \hline
        ID\_Producto & Nombre & Categoria & Precio \\
        \hline
    ...
    \end{tabular}
    \vspace{0.6cm}
    \textbf{\\Pedidos (igual que en 2FN)}\\[0.1cm]
    \begin{tabular}{ccc}
        \hline
        ID\_Pedido & ID\_Cliente & ID\_Producto \\
        \hline
