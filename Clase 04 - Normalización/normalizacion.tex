...
\begin{tabular}{llll}
\toprule
IdCiudadHotel & CiudadHotel & IdPaisHotel & NombrePaisHotel \\
\midrule
C1 & Buenos Aires & P1 & Argentina \\
C2 & Madrid & P2 & España \\
\bottomrule
\end{tabular}
\end{center}
...
\begin{tabular}{llll}
\toprule
IDHotel & HotelNombre & IdCiudadHotel & IdGerenteHotel \\
\midrule
H1 & Hotel A & C1 & G1\\
H2 & Hotel B & C2 & G2\\
\bottomrule
...
\begin{tabular}{ll}
\toprule
IdGerenteHotel & NombreGerenteHotel \\
\midrule
G1 & Juan Pérez \\
G2 & María López \\
\bottomrule
...
\begin{itemize}
    ...
    \item Se extrajo la información de hoteles, ciudades, clientes y reservas en tablas separadas (2FN)
    \item Se eliminaron las dependencias transitivas (3FN)
\end{itemize}

\section{Ejercicio Práctico}
Una empresa de ventas registra los pedidos de sus clientes. Normalizar la siguiente tabla hasta 3FN sabiendo que:

\begin{itemize}
    \item Un pedido puede contener múltiples productos
    \item Un cliente puede realizar múltiples pedidos
    \item Cada producto pertenece a una única categoría
    \item El precio es específico de cada producto
\end{itemize}

\begin{center}
\begin{tabular}{lllllll}
\toprule
ID\_Pedido & Cliente & CodPostal & Ciudad & Producto & Categoría & Precio \\
\midrule
1 & Juan & 1000 & CABA & Laptop & Electrónica & 1000 \\
2 & María & 1000 & CABA & Mouse & Electrónica & 20 \\
3 & Juan & 1000 & CABA & Mouse & Electrónica & 20 \\
\bottomrule
\end{tabular}
\end{center}
...
\begin{tabular}{llll}
\toprule
ID\_Cliente & Nombre & CodPostal & Ciudad \\
\midrule
C1 & Juan & 1000 & CABA \\
C2 & María & 1000 & CABA \\
\bottomrule
...
Tabla: Productos (igual que en 2FN)
\begin{center}
\begin{tabular}{llll}
\toprule
ID\_Producto & Nombre & Categoría & Precio \\
