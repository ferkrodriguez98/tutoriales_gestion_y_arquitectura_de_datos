...
\begin{frame}{A practicar}
    \begin{center}
        Buscá la guía de ejercicios en el repositorio de la materia.
    \vspace{0.5cm}

    {\color{secondary}
    \href{https://github.com/ferkrodriguez98/tutoriales_gestion_y_arquitectura_de_datos/blob/main/Guias\%20de\%20Ejercicios/01\%20-\%20Gestion\%20de\%20Datos/guia_preguntas_gestion_de_datos.pdf}{\textbf{\underline{Capaz funciona si haces click acá}}}
    }
    \end{center}
\end{frame}
