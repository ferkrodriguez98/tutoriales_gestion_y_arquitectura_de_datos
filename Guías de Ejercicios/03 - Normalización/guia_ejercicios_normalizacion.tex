...
\begin{tabular}{|l|l|l|}
\hline
Cancha & Horario\_Reserva & ID\_Socio \\
\hline
\end{tabular}
\end{center}
...
\begin{itemize}
    ...
    \item Modelo → Marca, Precio, Stock
\end{itemize}
...
\begin{tabular}{|l|l|l|l|}
\hline
ID\_Modelo & ID\_Marca & Precio & Stock \\
\hline
\end{tabular}
\end{center}
...
Nota: Poner ID\_Marca en la tabla de Instrumentos podría ser redundante si decimos que es una relación 1:1.
