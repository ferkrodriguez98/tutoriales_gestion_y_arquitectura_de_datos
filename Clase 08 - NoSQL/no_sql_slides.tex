...
\begin{frame}{Clasificación CAP de Bases de Datos}
    ...
    \vspace{0.5cm}
    \textbf{Nota}: MongoDB es configurable para priorizar Consistency o Availability. Redis por defecto prioriza AP (replicación asíncrona), pero puede configurarse como CP.
\end{frame}
