...
\textbf{Nota}: MongoDB es configurable para priorizar Consistency o Availability (modo CP o modo AP, por defecto es CP). Redis por defecto prioriza AP (replicación asíncrona), pero puede configurarse como CP con replicación síncrona. Neo4J no tolera particiones.
